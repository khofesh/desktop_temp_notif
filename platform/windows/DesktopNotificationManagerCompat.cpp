...
DesktopNotificationHistoryCompat::DesktopNotificationHistoryCompat(const wchar_t *aumid, Microsoft::WRL::ComPtr<IToastNotificationHistory> history)
{
...
{
    Microsoft::WRL::ComPtr<IToastNotificationHistory2> history2;
